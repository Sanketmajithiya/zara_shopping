...
class forgot(models.Model):
    Student_id = models.CharField(primary_key=True,max_length=255, blank=True)
    ...
    otp = models.CharField(max_length=10,default="11111")
    ...
    def save(self, *args, **kwargs):
        ...
        return super(forgot, self).save(*args, **kwargs)
    
    def generate_customer_id(self):
        last_customer = forgot.objects.order_by('-customer_id').first()
        if last_customer:
